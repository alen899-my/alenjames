...
const SKILLS: Skill[] = [
    { name: 'React', category: 'Frontend', level: 95, years: '4 yrs', description: 'Deep expertise in hooks, context, concurrent features, and performance optimization.', color: '#61dafb', bgColor: '#0a1f2e', imageFile: 'react.png', fallbackIcon: '⚛' },
    { name: 'Next.js', category: 'Frontend', level: 92, years: '3 yrs', description: 'Full-stack React framework. SSR, ISR, App Router, and edge middleware.', color: '#ffffff', bgColor: '#111111', imageFile: 'nextjs.png', fallbackIcon: 'N' },
    { name: 'TypeScript', category: 'Coding Languages', level: 90, years: '3 yrs', description: 'Advanced generics, decorators, utility types, and strict DX tooling.', color: '#3178c6', bgColor: '#071428', imageFile: 'typescript.png', fallbackIcon: 'TS' },
    { name: 'TailwindCSS', category: 'Frontend', level: 94, years: '3 yrs', description: 'Utility-first CSS mastery — design systems, responsive layouts, dark-mode theming.', color: '#38bdf8', bgColor: '#071520', imageFile: 'tailwind.png', fallbackIcon: '🌊' },
    { name: 'Vue.js', category: 'Frontend', level: 80, years: '2 yrs', description: 'Component architecture, Vuex state management, Composition API, and Nuxt.js.', color: '#42d392', bgColor: '#071a10', imageFile: 'vue.png', fallbackIcon: 'V' },
    { name: 'Python', category: 'Coding Languages', level: 88, years: '5 yrs', description: 'Data pipelines, ML training scripts, REST APIs, and scripting automation at scale.', color: '#f7d44c', bgColor: '#1a1800', imageFile: 'python.png', fallbackIcon: 'Py' },
    { name: 'FastAPI', category: 'Frontend', level: 85, years: '2 yrs', description: 'High-performance async APIs with Pydantic validation, OAuth2, and OpenAPI auto-docs.', color: '#05998b', bgColor: '#011a18', imageFile: 'fastapi.png', fallbackIcon: '⚡' },
    { name: 'Node.js', category: 'Frontend', level: 87, years: '4 yrs', description: 'Event-driven servers, REST and GraphQL APIs, streams, and microservice architecture.', color: '#84cc16', bgColor: '#0c1800', imageFile: 'nodejs.png', fallbackIcon: '⬡' },
    { name: 'PostgreSQL', category: 'Frontend', level: 84, years: '4 yrs', description: 'Schema design, query optimization, JSONB, full-text search, and Postgres extensions.', color: '#336791', bgColor: '#071020', imageFile: 'postgresql.png', fallbackIcon: '🐘' },
    { name: 'MongoDB', category: 'Frontend', level: 79, years: '3 yrs', description: 'Document modeling, aggregation pipelines, Atlas Search, and change streams.', color: '#4db33d', bgColor: '#071a04', imageFile: 'mongodb.png', fallbackIcon: '🍃' },
    { name: 'Docker', category: 'Other Skills', level: 80, years: '3 yrs', description: 'Multi-stage builds, Compose orchestration, health checks, and container security.', color: '#2496ed', bgColor: '#040f1e', imageFile: 'docker.png', fallbackIcon: '🐳' },
    { name: 'AWS', category: 'Other Skills', level: 78, years: '3 yrs', description: 'EC2, Lambda, S3, CloudFront, RDS, and CDK infrastructure-as-code.', color: '#ff9900', bgColor: '#1a0c00', imageFile: 'aws.png', fallbackIcon: '☁' },
    { name: 'Prisma', category: 'Frontend', level: 83, years: '2 yrs', description: 'Type-safe ORM with migrations, relation queries, and connection pooling.', color: '#5a67d8', bgColor: '#0a0b1a', imageFile: 'prisma.png', fallbackIcon: '▲' },
    { name: 'Three.js', category: 'Other Skills', level: 82, years: '2 yrs', description: 'Interactive 3D scenes, custom shaders, physically-based rendering, and WebGL effects.', color: '#ff6633', bgColor: '#1a0d07', imageFile: 'threejs.png', fallbackIcon: '◈' },
    { name: 'Git', category: 'Other Skills', level: 91, years: '6 yrs', description: 'Branching strategies, rebase workflows, hooks, monorepo management, and CI integration.', color: '#f05032', bgColor: '#1a0600', imageFile: 'git.png', fallbackIcon: '⑂' },
    { name: 'Redis', category: 'Frontend', level: 76, years: '2 yrs', description: 'Caching, pub/sub, sorted sets, sessions, and distributed locks for real-time apps.', color: '#dc382d', bgColor: '#1a0404', imageFile: 'redis.png', fallbackIcon: '🔴' },
    { name: 'GraphQL', category: 'Frontend', level: 81, years: '2 yrs', description: 'Schema-first design, Apollo Server/Client, subscriptions, and DataLoader.', color: '#e535ab', bgColor: '#1a0415', imageFile: 'graphql.png', fallbackIcon: '◉' },
    { name: 'Figma', category: 'Other Skills', level: 77, years: '3 yrs', description: 'UI design systems, component libraries, prototyping, and developer handoff.', color: '#f24e1e', bgColor: '#1a0800', imageFile: 'figma.png', fallbackIcon: '✦' },
    { name: 'Linux', category: 'Other Skills', level: 85, years: '5 yrs', description: 'Shell scripting, system administration, networking, cron jobs, and server hardening.', color: '#fcc624', bgColor: '#1a1400', imageFile: 'linux.png', fallbackIcon: '🐧' },
    { name: 'Rust', category: 'Coding Languages', level: 65, years: '1 yr', description: 'Systems programming, ownership model, safe concurrency, and WASM compilation targets.', color: '#ce422b', bgColor: '#1a0800', imageFile: 'rust.png', fallbackIcon: 'Rs' },
]
    ...
    return new Promise((resolve) => {
        ...
        loader.load(
            ...
            (tex) => {
                ...
                ctx.fillStyle = grd; ctx.fillRect(0, 0, S, S)
                const pad = 68
                ctx.drawImage(tex.image as HTMLImageElement, pad, pad, S - pad * 2, S - pad * 2)
